...
class Goods extends CActiveRecord{
     ...
     */
    //public $add_file;//添加页面时，传选择的图片
    //public $update_file;//修改页面时，更换图片
    ...
    function attributeLabels() {
     ...
     public function rules() {
        return array(
            ...
            array('goods_image','file','allowEmpty'=>true,'types'=>'jpeg,bmp,tiff,psd,swf,svg,jpg,png,gif','maxSize'=>1024*1024*10,'tooLarge'=>'文件大于10M，上传失败！请上传小于10M的文件！'),
